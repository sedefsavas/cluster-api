...
// GetClusterAPITObjectsInput is the input for GetCAPIResources.
...
// DumpAllResources dump cluster API related resources to YAML
// This list includes all the types defines by the CRDs installed by clusterctl.
