...
type ManagementCluster interface {
	...
	TargetClusterAnalyseEtcdHealth(ctx context.Context, controlPlane *ControlPlane, clusterKey client.ObjectKey) error
	TargetClusterAnalyseControlPlaneHealth(ctx context.Context, controlPlane *ControlPlane, clusterKey client.ObjectKey) error
...
func (m *Management) TargetClusterAnalyseControlPlaneHealth(ctx context.Context, controlPlane *ControlPlane, clusterKey client.ObjectKey) error {
...
func (m *Management) TargetClusterAnalyseEtcdHealth(ctx context.Context, controlPlane *ControlPlane, clusterKey client.ObjectKey) error {
