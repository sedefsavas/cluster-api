...
const (
	...
	// PodIsNotReadyReason (Severity=Warning) documents a pod is not ready. This is a generic reason to be used when reason is unidentified.
	PodIsNotReadyReason = "PodIsNotReady"
)
